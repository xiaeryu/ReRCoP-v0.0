ReRCoP: Recombination Removal for Core-genome Phylogeny
Core-genome phylogeny of large bacterial population samples with recombination removal
...
7. clustalo. (For multiple sequence alignment. Find here: http://www.clustal.org/omega/)
...
2. A file in multiple nucleotide fasta format with genome sequences.
	...
	Assembled contigs: Concatenate the contigs to form one fake genome sequence, which can be done with the script FormatContig.pl in ./scripts.
		Usage: perl FormatContig.pl <contig fasta file> <header of the output fasta file> <output fasta file>
